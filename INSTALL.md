...
- `yt-dlp` is used as a fallback resolver. Keep it at `2026.3.3` or newer (`pip install --upgrade yt-dlp`) whenever YouTube changes break playback; the installer enforces this minimum.
